...
export default function ContactSheet({ person, onClose, onToast, models, isMe, currentProfile }) {
  ...
  return (
    <>
      <div className="flex flex-col items-center pt-4 pb-2 gap-1">
        ...
        <span className="text-[10px] tracking-widest uppercase font-sans text-[#888580]">
          {specialtyLabel(person)}
        </span>
      </div>

      {isMe ? (
        <div className="px-4 py-6 border-t border-[#E0DDD8] dark:border-[#2E2B28]">
          <p className="text-[11px] font-sans text-[#888580] text-center tracking-wide">This is you</p>
        </div>
      ) : (
        <>
          ...
          <div className="flex gap-3 px-4 pb-6 border-t border-[#E0DDD8] dark:border-[#2E2B28] pt-4">
            <a href={`tel:${person.phone || ''}`} className="flex-1 flex items-center justify-center gap-2 border border-[#D0CCC7] dark:border-[#3A3632] rounded py-3 text-[11px] font-sans tracking-widest uppercase text-[#111] dark:text-[#F0EDE8]">
              CALL
            </a>
            <a href={`sms:${person.phone || ''}`} className="flex-1 flex items-center justify-center gap-2 border border-[#D0CCC7] dark:border-[#3A3632] rounded py-3 text-[11px] font-sans tracking-widest uppercase text-[#111] dark:text-[#F0EDE8]">
              TEXT
            </a>
          </div>
        </>
